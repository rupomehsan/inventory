                ...
                <div class="card-body card_body_fixed_height">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for=""
                                    >Enter your currency exchange rate</label
                                >
                                <div class="mt-1 mb-3">
                                    <input
                                        class="form-control form-control-square mb-2"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for=""
                                    >Enter your expected time of delivery</label
                                >
                                <div class="mt-1 mb-3">
                                    <input
                                        class="form-control form-control-square mb-2"
                                        ...
                                        v-model="
                                            formData.expected_time_of_delivery
                                        "
                                    />
                                </div>
                                <!--v-if--><!--v-if--><!--v-if-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                readonly
                                                v-model="
                                                    update_total_price.total_in_bdt
                                                "
                                            />
                                        </td>
                                    </tr>
    ...
    methods: {
        ...
        set_fields: async function (id) {
            ...
            if (this.item) {
                ...
                this.formData.currency_exchange_rate =
                    this.item.currency_exchange_rate;
        ...
        recalculateProductItems() {
            const itemTotal = this.product_items.reduce((total, item) => {
                ...
                item.subtotal_in_bdt =
                    ...
                    Number(this.formData.currency_exchange_rate); // Conversion logic
            ...
            this.update_total_price.total_in_bdt =
                Number(itemTotal) *
                Number(this.formData.currency_exchange_rate);
        },
