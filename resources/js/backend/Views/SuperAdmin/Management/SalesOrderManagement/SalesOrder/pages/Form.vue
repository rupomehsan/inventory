    ...
    <form @submit.prevent="submitHandler">
      <div class="card">
        <div class="card-header d-flex justify-content-between">
          ...
          <div><!--v-if--><a href="#/purchase-order/all" class="btn btn-outline-warning btn-sm">All Sales Order</a></div>
        </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="mt-1 mb-3">
                  <input class="form-control form-control-square mb-2" type="text" name="title" id="title" v-model="formData.title" />
                </div>
                <!--v-if--><!--v-if--><!--v-if-->
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="mt-1 mb-3">
                  <input class="form-control form-control-square mb-2" type="text" name="reference" id="reference" v-model="formData.reference" />
                </div>
                <!--v-if--><!--v-if--><!--v-if-->
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="mt-1 mb-3">
                  ...
                  >
                    ...
                    <option v-for="item in customers" :key="item" :value="item.id">
                      {{ item.name }}
                    </option>
                  </select>
                </div>
          ...
          <div class="row justify-content-center my-3">
            <div class="col-md-7">
              <div class="form-group">
                ...
                <select name="" id="" class="form-control" @change="set_product_item($event.target.value)">
            ...
            <table class="table table-bordered table-hover table-striped">
              ...
              <tbody>
                <tr v-for="(item, index) in formData.product_items" :key="index">
                  ...
                  <td>
                    <input readonly class="form-control form-control-square" type="number" v-model="item.available_quantity" />
                  </td>
                  <td>
                    <input class="form-control form-control-square" type="number" v-model="item.price" />
                  </td>

                  <td>
                    <input class="form-control form-control-square" type="text" v-model="item.subtotal" />
                  </td>
                  <td>
              ...
              <div class="col-md-4">
                <table class="table table-bordered table-hover table-striped">
                  <tr>
                    ...
                    <td>
                      <input class="form-control form-control-square" type="number" readonly v-model="formData.subtotal" />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input class="form-control form-control-square" type="number" v-model="formData.discount" />
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">Grand Total</td>
                    <td>
                      <input class="form-control form-control-square" type="number" readonly v-model="formData.total" />
                    </td>
                  </tr>
                  <tr v-if="!param_id">
                    <td colspan="2">Paid</td>
                    <td>
                      <input class="form-control form-control-square" type="number" v-model="formData.paid" />
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">Due</td>
                    <td>
                      <input class="form-control form-control-square" type="number" readonly v-model="formData.due" />
                    </td>
                  </tr>
                </table>
              </div>
...
export default {
  ...
  methods: {
    ...
    set_product_item: async function (id) {
      ...
      let response = await axios.get(`get-product-stock-quantity-by-product-id/${id}`);
